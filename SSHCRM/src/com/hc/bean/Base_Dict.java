...
public class Base_Dict {
	/**
	 *  dict_id         varchar(32)
		dict_type_code  varchar(10)
		dict_type_name  varchar(64)
		dict_item_name  varchar(64)
		dict_item_code  varchar(10)
		dict_sort       int(10)    
		dict_enable     char(1)    
		dict_memo       varchar(64)
	 */
	...
	public String toString() {
		return "Base_Dict [dict_id=" + dict_id + ", dict_type_code=" + dict_type_code + ", dict_type_name="
