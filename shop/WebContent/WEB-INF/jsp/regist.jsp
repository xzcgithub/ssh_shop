...
function checkCode3(){
	...
	if(pwd != rpwd ){
		$("#codeId3").addClass("codeId3");
		$("#codeId3").html("两次密码不一致！");
	}
}
function checkCode(){
					...
					<form id="registerForm" action="${pageContext.request.contextPath}/user_regist.action" method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							<tbody><tr>
								...
								<td>
									<input onblur="checkCode()" type="text" id="username" name="username" class="text" maxlength="20">
							...
							<tr>
								...
								<td>
									...
									<SPAN id="codeId2" style="FONT-WEIGHT: bold;"></SPAN>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									...
									<SPAN id="codeId3" style="FONT-WEIGHT: bold;"></SPAN>
								</td>
							</tr>
							<tr>
								<th>
