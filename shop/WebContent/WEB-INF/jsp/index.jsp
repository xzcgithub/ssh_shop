...
<div class="container header">海辰科技招聘
	<div class="span5">
		<div class="logo">
			<a href="./网上商城/index.htm">
				<img src="${pageContext.request.contextPath}/image/.r___________renleipic_01/logo.gif" alt="便宜甩卖"/>
			</a>
		</div>
	</div>
	<div class="span9">
			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<ul class="tabContent" style="display: block;">
							<c:forEach items="${hlist }" var="p">
									<li>
										<a href="${pageContext.request.contextPath}/product_findByPid?pid=${p.pid}" target="_blank"><img src="${pageContext.request.contextPath}/${p.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
									</li>
							</c:forEach>
						</ul>
...
<!-- 					<div class="newProductAd">
						 ...
						 <ul class="tabContent" style="display: block;">
						 	<c:forEach items="${nlist }" var="p">
									<li>
										<a ${pageContext.request.contextPath}/product_findByPid?pid=${p.pid} target="_blank"><img src="${pageContext.request.contextPath}/${p.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>									
									</li>
							</c:forEach>	
						</ul>
						<ul class="tabContent" style="display: none;">
